...
(kind, value): object;
  ...
  named: ReplaceFactories<any & KeyedByArray<Shorten<string, A, NonZeroFlags>, Shorten<string, A, NonZeroFlags> extends infer T_1 ? T_1 extends Shorten<..., ..., ...> ? ... extends ... ? ... : ... : never : never[number]>, Shorten<string, A, NonZeroFlags>[number], 
     | 0
    | Shorten<string, A, NonZeroFlags> extends infer T_2 ? T_2 extends Shorten<string, A, NonZeroFlags> ? T_2 extends [..., ...] ? [..., ...] : [] : never : never[number], object & KeyedByArray<Shorten<string, A, NonZeroFlags>, boolean>>;
  nameOf: "composed" | "flattened" | "nested";
  none: 0;
  of: object;
  reduce: number;
} & KeyedByArray<["composed", "flattened", "nested"], 1 | 2 | 4>, "composed" | "flattened" | "nested", 0 | 1 | 2 | 4, object & KeyedByArray<["composed", "flattened", "nested"], boolean>>;
```

...
[Alfa API documentation](../../../README.md) / [@siteimprove/alfa-dom](../../alfa-dom.md) / [Rule](../Rule.md) / from
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](FontFace/JSON.md) |
| `sheetFactory` | (`rules`) => [`Sheet`](../Sheet-1.md) |

### Returns

[`FontFace`](FontFace-2.md)
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](Keyframe/JSON.md) |
| `sheetFactory` | (`rules`) => [`Sheet`](../Sheet-1.md) |

### Returns

[`Keyframe`](Keyframe-2.md)
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](Layer/Statement/JSON.md) |
| `sheetFactory` | (`rules`) => [`Sheet`](../Sheet-1.md) |

### Returns

[`Statement`](Layer/Statement-1.md)
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](Namespace/JSON.md) |
| `sheetFactory` | (`rules`) => [`Sheet`](../Sheet-1.md) |

### Returns

[`Namespace`](Namespace-2.md)
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](Supports/JSON.md) |
| `sheetFactory` | (`rules`) => [`Sheet`](../Sheet-1.md) |

### Returns

[`Supports`](Supports-2.md)

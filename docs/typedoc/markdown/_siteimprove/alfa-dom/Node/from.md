...
[Alfa API documentation](../../../README.md) / [@siteimprove/alfa-dom](../../alfa-dom.md) / [Node](../Node.md) / from
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](../Attribute/JSON.md) |
| `device?` | `Device` |

### Returns

[`Attribute`](../Attribute-1.md)
...
| Parameter | Type |
| ------ | ------ |
| `json` | [`JSON`](../Comment/JSON.md) |
| `device?` | `Device` |

### Returns

[`Comment`](../Comment-1.md)

...
[Alfa API documentation](../../../README.md) / [@siteimprove/alfa-dom](../../alfa-dom.md) / [Element](../Element.md) / isReplaced
...
element is Element\<"object" \| "input" \| "audio" \| "canvas" \| "embed" \| "iframe" \| "img" \| "video"\>

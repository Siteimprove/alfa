...
[Alfa API documentation](../../../../README.md) / [@siteimprove/alfa-act](../../../alfa-act.md) / [Rule](../../Rule.md) / [Composite](../Composite.md) / Evaluate
...
| ------ | ------ | ------ |
| `expectations()` | (`outcomes`) => `object` | [alfa-act/src/rule.ts](https://github.com/Siteimprove/alfa/blob/main/packages/alfa-act/src/rule.ts) |

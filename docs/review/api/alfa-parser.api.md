...
export namespace Parser {
    ...
    export function exclusive<I, T, E, A extends Array_2<unknown> = []>(pairs: Array_2<[
    peeker: Parser<I, unknown, unknown, A>,
    parser: Parser<I, T, E, A>
    ]>, ifNoPeek: Mapper<I, E, A>): Parser<I, T, E, A>;
    export function exclusive<I, T, U, E, A extends Array_2<unknown> = []>(peeker: Parser<I, U, unknown, A>, pairs: Array_2<[Predicate<U>, Parser<I, T, E, A>]>, ifNoMatch: Mapper<I, E, A>, ifNoPeek?: Mapper<I, E, A>): Parser<I, T, E, A>;
    // (undocumented)
    ...
    // (undocumented)
    export function final<I extends Iterable<unknown>, T, E, A extends Array_2<unknown> = []>(parser: Parser<I, T, E, A>, ifError: Mapper<I extends Iterable<infer T> ? T : unknown, E>): Parser<I, T, E, A>;
    // (undocumented)
    ...
    // (undocumented)
    export function skip<I, E, A extends Array_2<unknown> = []>(parser: Parser<I, unknown, E, A>): Parser<I, void, E, A>;
    // (undocumented)
    export function skipUntil<I, E, A extends Array_2<unknown> = []>(parser: Parser<I, unknown, E, A>, delimiter: Parser<I, unknown, E, A>): Parser<I, void, E, A>;
    // (undocumented)

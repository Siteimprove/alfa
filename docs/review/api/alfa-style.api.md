...
export namespace Longhands {
    ...
    longHands: {
        ...
        readonly "background-image": Longhand<List<import("./property/background-image").Specified.Item>, List<Image | Keyword<"none">>>;
        readonly "background-origin": Longhand<List<Box>, List<Box>>;
        readonly "background-position-x": Longhand<List<import("./property/background-position-x").Specified.Item>, List<Position | (Length<"px"> | Percentage.Fixed<Numeric.Type>) | Position<Position, Length<"px"> | Percentage.Fixed<Numeric.Type>>>>;
        readonly "background-position-y": Longhand<List<import("./property/background-position-y").Specified.Item>, List<Position | (Length<"px"> | Percentage.Fixed<Numeric.Type>) | Position<Position, Length<"px"> | Percentage.Fixed<Numeric.Type>>>>;
        ...
        readonly "border-image-width": Longhand<Specified_9, Tuple<[top: Percentage.Canonical | Length | Number_2.Fixed | Keyword<"auto">, right: Percentage.Canonical | Length | Number_2.Fixed | Keyword<"auto">, bottom: Percentage.Canonical | Length | Number_2.Fixed | Keyword<"auto">, left: Percentage.Canonical | Length | Number_2.Fixed | Keyword<"auto">]>>;
        ...
        readonly "box-shadow": Longhand<Keyword<"none"> | List<Shadow<Length<Unit.Length>, Length<Unit.Length>, Length<Unit.Length>, Length<Unit.Length>, Color>>, Keyword<"none"> | List<Shadow.Canonical>>;
        ...
        readonly height: Longhand<Percentage | Keyword<"auto"> | Length, Percentage.Canonical | Length | Keyword<"auto">>;
        ...
        readonly "margin-bottom": Longhand<Percentage | Keyword<"auto"> | Length, Percentage | Length | Keyword<"auto">>;
        readonly "margin-left": Longhand<Percentage | Keyword<"auto"> | Length, Percentage | Length | Keyword<"auto">>;
        readonly "margin-right": Longhand<Percentage | Keyword<"auto"> | Length, Percentage | Length | Keyword<"auto">>;
        readonly "margin-top": Longhand<Percentage | Keyword<"auto"> | Length, Percentage | Length | Keyword<"auto">>;
        readonly "min-height": Longhand<Percentage | Keyword<"auto"> | Length | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">, Percentage | Length | Keyword<"auto"> | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">>;
        readonly "min-width": Longhand<Percentage | Keyword<"auto"> | Length | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">, Percentage | Length | Keyword<"auto"> | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">>;
        readonly opacity: Longhand<Percentage | Number_2, Number_2.Fixed>;
        readonly "outline-color": Longhand<Color | Keyword<"invert">, Color | Keyword<"invert">>;
        ...
        readonly "text-shadow": Longhand<Keyword<"none"> | List<Shadow<Length<Unit.Length>, Length<Unit.Length>, Length<Unit.Length>, Length<Unit.Length>, Color>>, Keyword<"none"> | List<Shadow.Canonical>>;
        ...
        readonly transform: Longhand<Keyword<"none"> | List<Transform>, Keyword<"none"> | List<Transform.Canonical>>;
        ...
        readonly width: Longhand<Percentage | Keyword<"auto"> | Length, Percentage.Canonical | Length | Keyword<"auto">>;

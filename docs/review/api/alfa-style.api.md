...
export namespace Longhands {
    ...
    longHands: {
        ...
        "background-image": Longhand<List<Specified_2.Item>, List<Keyword<"none"> | Image.PartiallyResolved>>;
        ...
        "border-block-end-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        "border-block-end-width": Longhand<Specified_7, Length>;
        "border-block-start-color": Longhand<Color, Color.Canonical>;
        "border-block-start-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        ...
        "border-bottom-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        ...
        "border-image-slice": Longhand<Specified_10, Tuple<[top: Percentage.Canonical | Number_2.Fixed, right: Percentage.Canonical | Number_2.Fixed, bottom: Percentage.Canonical | Number_2.Fixed, left: Percentage.Canonical | Number_2.Fixed]> | Tuple<[top: Percentage.Canonical | Number_2.Fixed, right: Percentage.Canonical | Number_2.Fixed, bottom: Percentage.Canonical | Number_2.Fixed, left: Percentage.Canonical | Number_2.Fixed, fill: Keyword<"fill">]>>;
        "border-image-source": Longhand<Specified_11, Keyword<"none"> | Image.PartiallyResolved>;
        ...
        "border-inline-end-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        "border-inline-end-width": Longhand<Specified_7, Length>;
        "border-inline-start-color": Longhand<Color, Color.Canonical>;
        "border-inline-start-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        "border-inline-start-width": Longhand<Specified_7, Length>;
        "border-left-color": Longhand<Color, Color.Canonical>;
        "border-left-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        "border-left-width": Longhand<Specified_7, Length>;
        "border-right-color": Longhand<Color, Color.Canonical>;
        "border-right-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        ...
        "border-top-style": Longhand<Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"hidden" | "none" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        ...
        "clip-path": Longhand<Keyword<"none"> | URL | Shape<Shape.Basic, Box.Geometry>, Keyword<"none"> | URL | Shape<Shape.Basic, Box.Geometry>>;
        ...
        float: Longhand<Keyword.ToKeywords<"left" | "right" | "none">, Keyword.ToKeywords<"left" | "right" | "none">>;
        "font-family": Longhand<List<Keyword<"serif"> | Keyword<"sans-serif"> | Keyword<"cursive"> | Keyword<"fantasy"> | Keyword<"monospace"> | String_2>, List<Keyword<"serif"> | Keyword<"sans-serif"> | Keyword<"cursive"> | Keyword<"fantasy"> | Keyword<"monospace"> | String_2>>;
        ...
        "line-height": Longhand<LengthPercentage | Number_2 | Keyword<"normal">, Computed>;
        "margin-bottom": Longhand<Length | Keyword<"auto"> | Percentage, Length | Keyword<"auto"> | Percentage>;
        "margin-left": Longhand<Length | Keyword<"auto"> | Percentage, Length | Keyword<"auto"> | Percentage>;
        "margin-right": Longhand<Length | Keyword<"auto"> | Percentage, Length | Keyword<"auto"> | Percentage>;
        "margin-top": Longhand<Length | Keyword<"auto"> | Percentage, Length | Keyword<"auto"> | Percentage>;
        ...
        "min-height": Longhand<Length | Keyword<"auto"> | Percentage | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">, Length | Keyword<"auto"> | Percentage | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">>;
        "min-width": Longhand<Length | Keyword<"auto"> | Percentage | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">, Length | Keyword<"auto"> | Percentage | Keyword<"fit-content"> | Keyword<"max-content"> | Keyword<"min-content">>;
        "mix-blend-mode": Longhand<Keyword.ToKeywords<"color" | "normal" | "multiply" | "screen" | "overlay" | "darken" | "lighten" | "color-dodge" | "color-burn" | "hard-light" | "soft-light" | "difference" | "exclusion" | "hue" | "saturation" | "luminosity" | "plus-darker" | "plus-lighter">, Keyword.ToKeywords<"color" | "normal" | "multiply" | "screen" | "overlay" | "darken" | "lighten" | "color-dodge" | "color-burn" | "hard-light" | "soft-light" | "difference" | "exclusion" | "hue" | "saturation" | "luminosity" | "plus-darker" | "plus-lighter">>;
        ...
        "outline-style": Longhand<Keyword.ToKeywords<"none" | "auto" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">, Keyword.ToKeywords<"none" | "auto" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset">>;
        ...
        "overflow-x": Longhand<Keyword.ToKeywords<"hidden" | "scroll" | "auto" | "visible" | "clip">, Keyword<"scroll"> | Keyword<"auto"> | Keyword<"hidden"> | Keyword<"visible"> | Keyword<"clip">>;
        "overflow-y": Longhand<Keyword.ToKeywords<"hidden" | "scroll" | "auto" | "visible" | "clip">, Keyword<"scroll"> | Keyword<"auto"> | Keyword<"hidden"> | Keyword<"visible"> | Keyword<"clip">>;
        ...
        position: Longhand<Keyword.ToKeywords<"relative" | "fixed" | "static" | "absolute" | "sticky">, Keyword.ToKeywords<"relative" | "fixed" | "static" | "absolute" | "sticky">>;
        right: Longhand<LengthPercentage | Keyword<"auto">, LengthPercentage | Keyword<"auto">>;
        rotate: Longhand<Keyword<"none"> | Rotate, Keyword<"none"> | Rotate>;
        ...
        "text-indent": Longhand<LengthPercentage | Percentage.Fixed<"length"> | Length | Percentage.Calculated<"length"> | Length<Unit.Length>, LengthPercentage>;
        ...
        "white-space-trim": Longhand<Keyword<"none"> | TrimFlags, Keyword<"none"> | TrimFlags>;
        width: Longhand<LengthPercentage | Keyword<"auto">, LengthPercentage | Keyword<"auto">>;
        "will-change": Longhand<Keyword<"auto"> | List<Keyword<"contents"> | Keyword<"scroll-position"> | CustomIdent>, Keyword<"auto"> | List<Keyword<"contents"> | Keyword<"scroll-position"> | CustomIdent>>;
        ...
        "z-index": Longhand<Keyword<"auto"> | Integer, Integer.Fixed | Keyword<"auto">>;
    };
    const // (undocumented)
    aliases: {

  ...
  implements Slot, Slotable
{
  ...
  /*
   * This collects methods that are specific to some kind of elements.
   * Note that they can be used in the predicates that are included in the
   * namespace later in this very file, as long as the namespace is declared
   * after the class (so the references don't go full circle).
   */
  ...
  private _displaySize: number | undefined;
  ...
  /*
   * End of methods specific to some kind of elements.
   */

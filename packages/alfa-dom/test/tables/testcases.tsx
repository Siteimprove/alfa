...
export namespace smithonian {
  ...
  export const expected = Table.of(
    ...
    [
      ...
      makeCell("kg-mm", "header", 2, 1),
      makeCell("lb-in", "header", 3, 1),
      makeCell("hard", "data", 0, 2),
      makeCell("hard-yield", "data", 1, 2),
      makeCell("hard-kg", "data", 2, 2),
      makeCell("hard-lb", "data", 3, 2),
      makeCell("hard-elong", "data", 4, 2),
      makeCell("hard-reduct", "data", 5, 2),
      makeCell("medium", "data", 0, 3),
      makeCell("medium-yield", "data", 1, 3),
      makeCell("medium-kg", "data", 2, 3),
      makeCell("medium-lb", "data", 3, 3),
      makeCell("medium-elong", "data", 4, 3),
      makeCell("medium-reduct", "data", 5, 3),
      makeCell("soft", "data", 0, 4),
      makeCell("soft-yield", "data", 1, 4),
      makeCell("soft-kg", "data", 2, 4),
      makeCell("soft-lb", "data", 3, 4),
      makeCell("soft-elong", "data", 4, 4),
      makeCell("soft-reduct", "data", 5, 4),
    ],
...
export namespace apple {
  ...
  export const expected = Table.of(
    ...
    5,
    [
      makeCell("empty", "header", 0, 0),
      makeCell("2008", "header", 1, 0),
      makeCell("2007", "header", 2, 0),
      makeCell("2006", "header", 3, 0),
      makeCell("net", "header", 0, 1),
      makeCell("net-2008", "data", 1, 1),
      makeCell("net-2007", "data", 2, 1),
      makeCell("net-2006", "data", 3, 1),
      makeCell("cost", "header", 0, 2),
      makeCell("cost-2008", "data", 1, 2),
      makeCell("cost-2007", "data", 2, 2),
      makeCell("cost-2006", "data", 3, 2),
      makeCell("margin", "header", 0, 3),
      makeCell("margin-2008", "data", 1, 3),
      makeCell("margin-2007", "data", 2, 3),
      makeCell("margin-2006", "data", 3, 3),
      makeCell("percent", "header", 0, 4),
      makeCell("percent-2008", "data", 1, 4),
      makeCell("percent-2007", "data", 2, 4),
      makeCell("percent-2006", "data", 3, 4),
    ],
    [
...
export namespace expenses {
  ...
  export const expected = Table.of(
    ...
    [
      ...
      makeCell("2007", "header", 2, 0),
      makeCell("2006", "header", 3, 0),
      makeCell("rd", "header", 0, 1),
      makeCell("rd-2008", "data", 1, 1),
      makeCell("rd-2007", "data", 2, 1),
      makeCell("rd-2006", "data", 3, 1),
      makeCell("rd-percent", "header", 0, 2),
      makeCell("rd-percent-2008", "data", 1, 2),
      makeCell("rd-percent-2007", "data", 2, 2),
      makeCell("rd-percent-2006", "data", 3, 2),
      makeCell("sales", "header", 0, 3),
      makeCell("sales-2008", "data", 1, 3),
      makeCell("sales-2007", "data", 2, 3),
      makeCell("sales-2006", "data", 3, 3),
      makeCell("sales-percent", "header", 0, 4),
      makeCell("sales-percent-2008", "data", 1, 4),
      makeCell("sales-percent-2007", "data", 2, 4),
      makeCell("sales-percent-2006", "data", 3, 4),
    ],
    [
      RowGroup.of(0, 1, getById("thead")),
      RowGroup.of(1, 2, getById("body-1")),

...
export interface Option<T> extends Monad<T>, Functor<T> {
  isSome(): this is Some<T>;
  isNone(): this is None;
  map<U>(mapper: Mapper<T, U>): Option<U>;
  flatten<U>(): Option.Flattened<T, U>;
  flatMap<U>(mapper: Mapper<T, Option<U>>): Option<U>;
  reduce<U>(reducer: Reducer<T, U>, accumulator: U): U;
  and<U>(option: Option<U>): None | Option<U>;
  andThen<U>(option: Mapper<T, Option<U>>): None | Option<U>;
...
export namespace Option {
  export type Flattened<T, U> = T extends Option<U> ? Option<U> : Option<T>;

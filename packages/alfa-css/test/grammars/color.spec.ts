...
test("Can parse a RGBA color", t => {
  setSupportedBrowsers(
    [[Browser.Chrome, ">", "61"], [Browser.Firefox, ">", "48"]],
    () => {
  ...
  setSupportedBrowsers([[Browser.Firefox, "52"], [Browser.IE, "8"]], () => {
    color(t, "rgba(0, 50%, 100, 0.5)", {
      red: 0,
      green: 0,
      blue: 0,
...
test("Can parse a medium-long HEX color in browsers that support it", t => {
  setSupportedBrowsers(
    [[Browser.Chrome, ">=", "63"], [Browser.Firefox, ">=", "49"]],
    () => {
      color(t, "#ABCD", {
        red: 170,
        green: 187,
  ...
  setSupportedBrowsers(
    [[Browser.Firefox, "<=", "48"], [Browser.IE, "<=", "6"]],
    () => {
      color(t, "#ABCD", {
        red: 0,
        green: 0,

...
test("Passes when only element has only allowed ARIA-properties", t => {
...
test("Fails when element has only illegal ARIA-properties", t => {
...
test("Is inapplicable when element has no ARIA-properties", t => {

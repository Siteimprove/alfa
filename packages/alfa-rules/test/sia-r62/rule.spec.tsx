...
const defaultStyle = ComputedStyles.of(defaultProperties);
const focusStyle = ComputedStyles.of(focusProperties);
const noStyle = ComputedStyles.of(noDistinguishingProperties);

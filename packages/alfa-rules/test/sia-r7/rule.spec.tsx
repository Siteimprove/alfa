...
test("Passes when body has a valid language attributes", t => {
...
test("Fails when body has no valid language attributes", t => {
...
test("Fails when body has no language attributes", t => {

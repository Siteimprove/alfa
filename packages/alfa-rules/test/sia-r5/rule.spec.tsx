...
test("Passes when document has a valid language attributes", t => {
...
test("Fails when document has no valid language attributes", t => {
...
test("Fails when document has no language attributes", t => {

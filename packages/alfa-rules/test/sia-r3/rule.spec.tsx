...
test("evaluate() passes one id attribute in the document", async (t) => {
...
test("evaluate() passes unique id attributes in the document context.", async (t) => {
...
test("evaluate() fails duplicated id attributes in the document context.", async (t) => {
  ...
  test("evaluate() is inapplicable to a document without id", async (t) => {

...
test(`evaluate() passes an html element with lang attribute which has a non-empty ("") value.`, async (t) => {
...
test(`evaluate() fails an html element with lang attribute whose value is only ASCII whitespace.`, async (t) => {
...
test(`evaluate() fails an html element with xml:lang attribute.`, async (t) => {
    const target =  <html xml:lang="en"></html>;

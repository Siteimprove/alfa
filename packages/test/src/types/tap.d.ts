declare module 'tap' {
  ...
  export class Test {
    ...
    test (name: string, extra?: Options.Test, cb?: (t: Test) => Promise<void> | void): Promise<any>
    test (name: string, cb?: (t: Test) => Promise<void> | void): Promise<any>
    current (): Test
    ...
    beforeEach (fn: (cb: () => any) => Promise<void> | void): void

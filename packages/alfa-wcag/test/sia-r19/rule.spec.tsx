...
test("SIA-R19 fails when alement does not have any aria states or properties", t => {
...
test("SIA-R19 is inapplicable when alement does not have any aria states or properties", t => {

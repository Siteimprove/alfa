...
import { heading } from '../../../libs/markdown/heading.js';
import { horizontalRule } from '../../../libs/markdown/horizontal-rule.js';
import { i18n, ReflectionType, UnionType, } from 'typedoc';
    ...
    if (model.type instanceof UnionType) {
        ...
        model.type?.types?.forEach((type, i) => {
            if (type instanceof ReflectionType) {
                ...
                md.push(heading(options.headingLevel + 1, isFunction ? i18n.kind_function() : i18n.kind_type_literal()));
                ...
                if (this.helpers.hasUsefulTypeDetails(type)) {
                    md.push(this.partials.typeDeclarationContainer(model, type.declaration, {

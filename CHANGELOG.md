...
- [@siteimprove/alfa-dom](packages/alfa-dom): `Node#path()` now accepts `Node.Traversal` options to make it possible for construct XPath expression for various traversal modes. ([#245](../../pull/245))
